    ...
    <Card className="app_card dashboard_card shadow p-4 m-3">
        ...
        <Row>
            <table style={{border: '1px solid #ccc', padding: 12}} className= 'mt-5'>
                <thead>
                    <th style={{border: '1px solid #ccc', padding: "5px 10px"}}>Country Id</th>
                    <th style={{border: '1px solid #ccc', padding: "5px 10px"}}>Country Name</th>
                    <th style={{border: '1px solid #ccc', padding: "5px 10px"}}>Country Type</th>
