    ...
    >
      <div className="sign-in-div1">
        <div className="sign-in-div2">
          <div
            className="sign-in-div3"
            style={{ display: "flex", justifyContent: "space-between" }}
          >
            <p className="sign-in-para" onClick={() => goto("/sign-in")}>
              Sign in{" "}
            </p>
            <p
              style={{
            ...
            ></p>
            <p className="sign-in-para" onClick={() => goto("/sign-up")}>
              Register{" "}
            </p>
          </div>
          <div className="sign-in-div4">
            ...
            <button className="sign-in-bottom" onClick={submit}>
              {" "}
              {loading ? <span>Loading...</span> : <span>Login</span>}
            </button>
            <div>
              <p className="sign-in-para1">
