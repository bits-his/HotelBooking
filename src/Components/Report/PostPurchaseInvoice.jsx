...
export default function PostPurchaseInvoice() {
  ...
  const [post_purchase_invoice, setPost_purchase_invoice] = useState([]);

  const get_post_purchase_invoice = () => {
    _get(
      "api/get_post_purchase_invoice?query_type=select",
      (res) => {
        // navigate(-1)
        console.log(res);
        setPost_purchase_invoice(res.results);
      },
      (err) => {
        // setLoading(false)
        console.log(err);
          ...
          <div className="table_overflow">
            ...
            >
              ...
              <tbody>
                ...
                {post_purchase_invoice.length === 0 ? (
                  <span>Loading Rooms...</span>
                ) : (
                  post_purchase_invoice.map((item, index) => (
                    <tr>
                      <td
                        style={{
                          border: "1px solid rgb(12, 134, 103)",
