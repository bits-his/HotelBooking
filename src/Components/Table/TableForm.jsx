    ...
    data?.forEach((item, i) => {
      if (i === index) {
        ...
        let fifteenPofRoomRate =
          (parseFloat(value) + parseFloat(fivePofRate)) * 0.15;
        let RatRoomIncAllTax =
          parseFloat(value) +
          parseFloat(fivePofRate) +
          parseFloat(fifteenPofRoomRate);
        let totalRoomSales =
          parseFloat(item.night) *
          parseFloat(item.no_of_room) *
          RatRoomIncAllTax;
    ...
    data?.forEach((item, i) => {
      if (i === index) {
        ...
        let RatMealsIncAllTax =
          parseFloat(value) + parseFloat(fifteenPofMealRate);
        let totalsMealSales =
          parseFloat(item.night) *
          parseFloat(item.no_of_pax) *
          RatMealsIncAllTax;
    ...
    data?.forEach((item, i) => {
      if (i === index) {
        ...
        let fifteenPofRoomCost =
          (parseFloat(value) + parseFloat(fivePofRoomCost)) * 0.15;
    ...
    data?.forEach((item, i) => {
      if (i === index) {
        ...
        let RatMealsCostIncAllTax =
          parseFloat(value) + parseFloat(fifteenPofMealCost);
        let totalsMealCost =
          parseFloat(item.night) *
          parseFloat(item.no_of_pax) *
                ...
                <tr key={idx}>
                  ...
                  <td>
                    ...
                    >
                      ...
                      <option value="al_roudha_travel ">
                        Al Roudha Travel{" "}
                      </option>
                      <option value="roya_internaional">
                        Roya Internaional
                      </option>
                      <option value="al_rayan_ethiopia">
                        Al Rayan Ethiopia
                      </option>
                    </select>
                  </td>
