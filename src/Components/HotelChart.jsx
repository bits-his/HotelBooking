...
export default function HotelChart() {
  ...
  const repeatElement = (element) => (counts) => Array(counts).fill(element);
  ...
  return (
    <Card className="app_card dashboard_card shadow p-3 m-3">
      ...
      <Row>
        <Col md={12}>
          <h5 className="app_title mb-5" style={{ fontSize: 20 }}>
          ...
          <table>
            <thead>
              <tr>
                ...
                {header.map((i) => (
                  <th style={styles}>{moment(i).format("DD")}</th>
                ))}
              </tr>
            </thead>
            ...
            <thead>
              <tr>
                ...
                {header.map((i) => (
                  <th style={styles}>{moment(i).format("dddd")}</th>
                ))}
              </tr>
            </thead>
            <tbody>
